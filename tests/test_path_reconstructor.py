...
def test_convert_solution_to_line_and_add_to_graph():
    stops = [
    ...
    assert reconstructor.convert_solution_to_line(solution) == line
...
def test_reconstruct_sparse_path():
    ...
    assert reconstructor.reconstruct_sparse_path(solution) == stops
